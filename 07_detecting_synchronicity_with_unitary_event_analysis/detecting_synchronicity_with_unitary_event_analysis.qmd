...
## Applying Unitary Event Analysis to Simulated Data
 ...
 TODO: 
  - vary winsize parameter, relationship between winsize and number of trials
  - reduce numer of trials to make analysis run faster?
...
trials = [neuron.generate_n_spiketrains(2) for i in range(50)]
```
